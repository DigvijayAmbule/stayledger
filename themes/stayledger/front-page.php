            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 my-auto">
                        <p class="main-heading">STAYLEDGER: Your Financial Wizards for Short & Mid-Term Rental Success!</p>
                        <p class="sub-heading">Are you a short or mid-term rental owner or property manager burdened with the never-ending financial tasks and paperwork?</p>
                    </div>
                    <div class="col-sm-6">
                        <img class="img-thumbnail" src="<?php echo get_template_directory_uri()?>/assets/images/rocket-home.png">
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-6 my-auto">
                        <img class="img-thumbnail" src="<?php echo get_template_directory_uri()?>/assets/images/features.svg">
                    </div>
                    <div class="col-sm-6 order-first order-sm-5">
                        <h1>
                            How STAYLEDGER Will Transform Your Financial Landscape:
                        </h1><br>
                        <ul>
                            <li>
                    ...
                    <div class="row">
                        <div class="col-sm-4  d-flex justify-content-center">
                            <div class="card text-center pricingTier">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Essential Plan</h5>
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="#" class="btn btn-block btn-outline-dark">Go somewhere</a>
                                    </div>
                                </div>
                            </div>
                        </div>
